...
x_train_alt=[]
x_train_alt.extend(x_train_pos_alt)
x_train_alt.extend(x_train_neg_alt)
y_train_alt=[1]*len(x_train_pos_alt)+[0]*len(x_train_neg_alt)
...
print('sohu w2v svm rbf')
preds = m.predict(x_train)
print(metrics.classification_report(y_train, preds))
print(metrics.confusion_matrix(y_train, preds))

m=joblib.load('./shnu/shnu_w2v_nb_b.m')
print('sohu w2v BernoulliNB')
preds = m.predict(x_train)
print(metrics.classification_report(y_train, preds))
print(metrics.confusion_matrix(y_train, preds))

m=joblib.load('./shnu/shnu_w2v_nb_g.m')
print('sohu w2v GaussianNB')
preds = m.predict(x_train)
print(metrics.classification_report(y_train, preds))
print(metrics.confusion_matrix(y_train, preds))

m=joblib.load('./shnu/shnu_w2v_nb_m.m')
print('sohu w2v MultinomialNB')
preds = m.predict(minmax_scale(x_train))
print(metrics.classification_report(y_train, preds))
print(metrics.confusion_matrix(y_train, preds))

m=joblib.load('./shnu/shnu_w2v_svc_linear_alt.m')
print('shnu w2v svm linear')
preds = m.predict(x_train_alt)
print(metrics.classification_report(y_train_alt, preds))
print(metrics.confusion_matrix(y_train_alt, preds))

m=joblib.load('./shnu/shnu_w2v_svc_rbf_alt.m')
print('shnu w2v svm rbf')
preds = m.predict(x_train_alt)
print(metrics.classification_report(y_train_alt, preds))
print(metrics.confusion_matrix(y_train_alt, preds))

m=joblib.load('./shnu/shnu_w2v_nb_b_alt.m')
print('shnu w2v BernoulliNB')
preds = m.predict(x_train_alt)
print(metrics.classification_report(y_train_alt, preds))
print(metrics.confusion_matrix(y_train_alt, preds))

m=joblib.load('./shnu/shnu_w2v_nb_g_alt.m')
print('shnu w2v GaussianNB')
preds = m.predict(x_train_alt)
print(metrics.classification_report(y_train_alt, preds))
print(metrics.confusion_matrix(y_train_alt, preds))

m=joblib.load('./shnu/shnu_w2v_nb_m_alt.m')
print('shnu w2v MultinomialNB')
preds = m.predict(minmax_scale(x_train_alt))
print(metrics.classification_report(y_train_alt, preds))
print(metrics.confusion_matrix(y_train_alt, preds))
