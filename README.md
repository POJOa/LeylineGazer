...
B | Word2Vec(400维) | 搜狐新闻单月数据  | 支持向量机 | 与A对比特征语料的类型
C | Word2Vec(300维) | 校内数据训练集  | 支持向量机 | 与A对比特征语料的数量对比
D | TF-IDF | 校内数据训练集  | 支持向量机 | 与C对比特征提取工具，文本分类的主流方案
E | TF-IDF | 校内数据训练集  | 朴素贝叶斯 | 与C、D对比分类器，林涛论文的方案
